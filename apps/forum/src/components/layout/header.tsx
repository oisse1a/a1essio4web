      ...
      <nav className="page-wrap flex flex-wrap items-center gap-x-3 gap-y-2 py-3 sm:py-4">
        ...
        <div className="order-3 flex w-full flex-wrap items-center gap-x-4 gap-y-1 pb-1 text-sm font-semibold sm:order-0 sm:w-auto sm:flex-nowrap sm:pb-0">
          ...
          <details className="relative w-full sm:w-auto">
            <summary className="nav-link list-none cursor-pointer">板块</summary>
            <div className="mt-2 min-w-56 rounded-xl border border-(--line) bg-(--header-bg) p-2 shadow-lg sm:absolute sm:left-0"></div>
          </details>
          ...
          <details className="relative w-full sm:w-auto">
            <summary className="nav-link list-none cursor-pointer">Sandbox</summary>
            <div className="mt-2 min-w-56 rounded-xl border border-[var(--line)] bg-[var(--header-bg)] p-2 shadow-lg sm:absolute sm:right-0">
              ...
              <a
                ...
                className="block rounded-lg px-3 py-2 text-sm text-(--sea-ink-soft) no-underline transition hover:bg-[var(--link-bg-hover)] hover:text-[var(--sea-ink)]"
              >
                TanStack Query
              </a>
              <a
        ...
        <div className="ml-auto flex items-center gap-1.5 sm:gap-2">
          <a
            href="https://github.com/cloudbase/cloudbase"
            target="_blank"
            rel="noreferrer"
